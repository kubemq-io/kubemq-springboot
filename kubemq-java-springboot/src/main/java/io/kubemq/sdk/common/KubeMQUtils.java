...
public class KubeMQUtils {
     ...
     */
    public  Boolean createChannelRequest(KubeMQClient kubeMQClient, String clientId, String channelName, String channelType) throws CreateChannelException, GRPCException{
        try {
     ...
     * @throws GRPCException          If there was an error with gRPC communication.
     */
    public  Boolean deleteChannelRequest(KubeMQClient kubeMQClient, String clientId, String channelName, String channelType) throws DeleteChannelException, GRPCException{
        try {
            Kubemq.Request request = Kubemq.Request.newBuilder()
                    .setRequestID(UUID.randomUUID().toString())
                    .setRequestTypeData(Kubemq.Request.RequestType.Query)
     ...
     * @throws GRPCException         If there was an error with gRPC communication.
     */
    public  List<QueuesChannel> listQueuesChannels(KubeMQClient kubeMQClient, String clientId, String channelSearch) throws ListChannelsException, GRPCException {
        try {
     ...
     * @throws GRPCException         If there was an error with gRPC communication.
     */
    public  List<PubSubChannel> listPubSubChannels(KubeMQClient kubeMQClient, String clientId, String channelType, String channelSearch) throws ListChannelsException, GRPCException {
        try {
            Kubemq.Request request = Kubemq.Request.newBuilder()
                    .setRequestID(UUID.randomUUID().toString())
                    .setRequestTypeData(Kubemq.Request.RequestType.Query)
     ...
     * @throws GRPCException         If there was an error with gRPC communication.
     */
    public  List<CQChannel> listCQChannels(KubeMQClient kubeMQClient, String clientId, String channelType, String channelSearch) throws ListChannelsException, GRPCException {
        try {
            Request request = Request.newBuilder()
                    .setRequestID(UUID.randomUUID().toString())
                    .setRequestTypeData(Kubemq.Request.RequestType.Query)
