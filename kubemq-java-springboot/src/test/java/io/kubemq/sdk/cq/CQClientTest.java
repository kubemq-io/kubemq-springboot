...
@ContextConfiguration(classes = {CQClientTest.TestConfig.class})
public class CQClientTest {
    ...
    @BeforeEach
    public void setUp() {
        lenient().when(cqClient.getClient()).thenReturn(client);
        lenient().when(cqClient.getAsyncClient()).thenReturn(asyncClient);
    ...
    static class TestConfig {
        ...
        public CQClient cqClient() {
            return mock(CQClient.class);
        }

        @Bean
        public KubeMQUtils kubeMQUtils() {
            return  mock(KubeMQUtils.class);
        }
    }
